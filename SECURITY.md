...
`tenderhook` is under active pre-1.0 development. Security fixes are applied only to
...
1. Open the [**Security** tab](https://github.com/asmuelle/tenderhook/security) of this repository.
2. Click **Report a vulnerability** to open a private advisory
   ([direct link](https://github.com/asmuelle/tenderhook/security/advisories/new)).
